...
> 红锁是一种分布式锁, 他旨在解决单点故障问题.
> 
> 他的获取步骤是有一堆节点去获取锁, 如果有超过一半的节点获取成功了, 就认为成功,
> 关于红锁的使用, redis的创始者和一位分布式大佬还有过吵架, 他们的观点完全不同
> 
> 我个人也是比较倾向于不适用红锁, 一个是没有经过实际的检验, 我看不到他的运行效果, 另一个原因是在网络分区和节点故障下, 无法保证互斥性, 可能导致这种加锁不牢靠.
