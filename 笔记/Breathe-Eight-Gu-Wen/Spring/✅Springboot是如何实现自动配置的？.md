...
> 他是通过@SpringBootApplication注解上有一个@EnableAutoConfiguration注解,然后这上面有一个, @Import注解, 导入了AutoConfigurationImportSelector, 他会去扫描classpath下的org.springframework.boot.autoconfigure.AutoConfiguration.imports的这个来加载
...
![[1d971c25-e87d-48f0-973a-07c1acda7cf1.png]]
...
org.springframework.boot.au toconfigure.admin.SpringApplicationAdminJmxAutoConfiguration,\
