...
> 首先肯定不能为1, 也就是最好情况是每个桶中都有一个元素, 但是大概率是已经形成了链表, 冲突概率很大, 这样子不好, 性能不高, 我们怎么办呢?
> 
> 还有一种stackoverflow上的说法, 说是基于泊松定理(这个我看过那个文章, 数学不太好, 那个公式有点理解不了hhh), 然后算出来最佳的分布式0.69左右.
> 
> 那么为什么要设置成0.75呢?
> 
> 还有一层考虑是我们容量最小16, 每次 * 二, 也就是说 * 0.75永远都可以得到一个整数, 这可以让我们对于容量的个数是一个整数, 更好了.
